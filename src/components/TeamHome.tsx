    ...
    <div className="grid grid-cols-[auto_auto_1fr_auto_auto_1fr_auto] items-center gap-2 p-3 sm:p-4 hover:bg-muted/50 transition-colors">
      ...
      {keyPrefix === "recent" && (
        <div className="text-center ml-2 w-16 shrink-0">
          <div
            className={`text-base sm:text-lg font-bold ${game.result === "Win" ? "text-green-600" : "text-red-600"
              }`}
          >
            {game.score}
          </div>
          <div
            className={`text-xs sm:text-sm ${game.result === "Win" ? "text-green-500" : "text-red-500"
              }`}
          >
            {game.result}
          </div>
          ...
          <CardContent className="p-0">
            <div className="divide-y divide-border">
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 hover:bg-muted/50">
                ...
                <span
                  className={`text-lg sm:text-xl font-bold ${parseFloat(derivedStats.diff) >= 0
